...
const sections = [
    {
        ...
        items: [
            ...
            "시그니처 첫 달 보증 — 첫 트레이닝 세션에서 몸의 변화를 느끼지 못한 경우, 첫 세션 이후 요청 시 남은 3회분을 전액 환불합니다.",
        ],
    },
    {
        ...
        items: [
            "크루 회비는 시그니처 또는 프로토콜 멤버십에 월 40,000원을 더하는 형태이며, 월 단위로 납부합니다.",
            "시즌 개시 전 하차 시 납부한 회비 전액을 환불합니다.",
            "시즌 개시 후 중도 하차 시 다음 달 회비부터 발생하지 않으며, 이용 중인 달은 진행된 모임 기준으로 정산합니다.",
            "회비는 모임 운영을 위한 운영비로, 선발 이후에만 납부가 진행됩니다.",
        ],
    },
    {
        label: "03 — 마스터 프로토콜",
