    ...
    <div className="home-page" style={{ backgroundColor: "#f5f5f7", color: "#1d1d1f", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <main className="home-main" style={{ paddingTop: "128px" }}>
        ...
        <section className="home-hero" style={{ textAlign: "center", padding: "5.5rem 2rem 6rem", position: "relative" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.7rem, 6.4vw, 4.8rem)", fontWeight: 900, letterSpacing: 0, lineHeight: 1.12, margin: "0 0 1.8rem", color: "#111", wordBreak: "keep-all" }}>
            <span className="hero-overline" style={{ display: "block", color: "#FE7502", fontWeight: 800, letterSpacing: "0.06em", fontSize: "0.86rem", lineHeight: 1.4 }}>분당 · 프리미엄 보컬 트레이닝</span>
            <span className="hero-overline" style={{ display: "block", color: "#a1a1a6", fontWeight: 700, letterSpacing: "0.2em", fontSize: "0.66rem", lineHeight: 1.4, marginTop: "6px", marginBottom: "1.2rem", textTransform: "uppercase" }}>Everlasting Change</span>
      ...
      <footer style={{ background: "#f5f5f7", padding: "4rem 2rem", borderTop: "1px solid rgba(0,0,0,0.05)", color: "#86868b", fontSize: "0.85rem", textAlign: "center" }}>
        <nav aria-label="사이트 안내" style={{ maxWidth: "760px", margin: "0 auto 1.1rem", display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "0.55rem 1.4rem", lineHeight: 1.8 }}>
          <Link href="/bundang-vocal-lesson" style={{ color: "#86868b", textDecoration: "underline" }}>
            분당 보컬레슨 안내
          </Link>
          <Link href="/adult-vocal-lesson" style={{ color: "#86868b", textDecoration: "underline" }}>
            성인 보컬레슨 · 취미 보컬
          </Link>
          <Link href="/vocal-correction" style={{ color: "#86868b", textDecoration: "underline" }}>
            발성교정 · 목조임 훈련
          </Link>
          <Link href="/signature" style={{ color: "#86868b", textDecoration: "underline" }}>
            1:1 보컬 트레이닝 시그니처
          </Link>
          <Link href="/spark" style={{ color: "#86868b", textDecoration: "underline" }}>
            매일 보컬 연습 루틴 데일리
          </Link>
          <Link href="/reserve" style={{ color: "#86868b", textDecoration: "underline" }}>
            15주 마스터 프로토콜
          </Link>
          <Link href="/diagnosis" style={{ color: "#86868b", textDecoration: "underline" }}>
            3분 무료 발성 진단
          </Link>
        ...
        <p style={{ marginBottom: "0.75rem" }}>
          경기 성남시 분당구의 1:1 프리미엄 보컬 트레이닝 스튜디오 — 분당 · 정자동 · 서현동 · 수내동 · 이매동 · 야탑동 · 미금동 · 구미동 · 판교 · 용인 수지 보컬레슨
        </p>
