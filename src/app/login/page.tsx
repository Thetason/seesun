...
export default function LoginPage() {
    ...
    return (
        <div className="auth-page" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#050507", padding: "1.25rem" }}>
            <div className="glass-panel auth-panel" style={{ width: "100%", maxWidth: "400px", padding: "2.5rem", borderRadius: "24px", border: "1px solid rgba(255,255,255,0.05)", background: "rgba(30,30,32,0.4)", backdropFilter: "blur(20px)" }}>
